    ...
    return (
        <div>
            <Card 
                ...
                type="inner"
                title={title}
                extra={<><Button style={{display: 'block'}}><Link to={{ pathname: `/bookings/${booking}` }} state={{ booking: booking, deptFlight: deptFlight, retFlight: retFlight, amount: amount, userData: userData }}>
                    View Itinerary
                </Link>
                </Button>&nbsp;
